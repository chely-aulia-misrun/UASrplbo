            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body p-0">
                        <div class="media p-3">
                            <div class="media-body">
                                <span class="text-muted text-uppercase font-size-12 font-weight-bold">Siswa</span>
                                <h2 class="mb-0">{{count($siswa)}}</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body p-0">
                        <div class="media p-3">
                            <div class="media-body">
                                <span class="text-muted text-uppercase font-size-12 font-weight-bold">Kelas</span>
                                <h2 class="mb-0">{{count($kelas)}}</h2>
                            </div>
                        </div>
                    </div>
                </div>
